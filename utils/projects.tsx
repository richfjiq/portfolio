export const projects = [
	...
	},
	{
		...
		description:
			'This app was built with Node.Js. This app allows the user to manage the exchange of data necessary for web (Sportika) and mobile (Sportika Mobile) e-commerce works.',
