		...
		<Navbar title="About">
			<div className="max-w-[1240px] m-auto gap-8">
				...
				<div className={`grid grid-cols-12 ${styles.container}`}>
					...
					>
						<p className="py-5 text-left text-linen-600 text-base min-[700px]:text-left min-[700px]:text-xl">
						...
						<p className="text-linen-600 text-left min-[700px]:text-left text-base min-[700px]:text-xl">
							I&apos;m a well-organized person, problem solver, with high attention to detail.
						</p>
						<p className="py-5 text-left min-[700px]:text-left text-linen-600 text-base min-[700px]:text-xl">
