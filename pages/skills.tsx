		...
		<Navbar>
			<div>
				<div className="max-w-[1240px] pb-10 sm:pb-0 text-center mx-auto flex flex-col h-full">
					<h2 className="p-4 sm:pb-5 sm:pt-0">Some of my skills...</h2>
					<div className="grid grid-cols-2 min-[440px]:grid-cols-3 gap-4 sm:gap-5 md:gap-10 px-5">
						{skills.skills.map((skill) => (
							<div
								key={skill.title}
								className="bg-[#ffffff]/40 hover:bg-[#ffffff]/70  py-2 px-4 min-[440px]:px-2 min-[440px]:py-4 min-[520px]:p-5 shadow-xl rounded-xl hover:scale-105 ease-in duration-300"
							>
								<div className="grid grid-cols-1 md:grid-cols-2 justify-center items-center">
									...
									<div className="flex flex-col items-center justify-center mt-2 min-[440px]:mt-5 md:mt-0">
										<h3 className="text-[#374785]">{skill.title}</h3>
									</div>
								</div>
							</div>
						))}
