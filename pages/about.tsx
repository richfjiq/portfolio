		...
		<Navbar title="About">
			<div className="max-w-[1240px] m-auto gap-8">
				<div className={`flex justify-center ${styles.headerContainer}`}>
					<h1 className={`mb-5 mt-5 min-[440px]:mt-0 text-center`}>About me</h1>
				</div>
				<div className={`grid grid-cols-12 ${styles.container}`}>
					...
					>
						<p className="py-5 text-justify text-[#f7f1e3]-600 text-base min-[700px]:text-left min-[700px]:text-xl min-[1100px]:text-2xl">
						...
						<p className="text-[#f7f1e3]-600 text-justify min-[700px]:text-left text-base min-[700px]:text-xl min-[1100px]:text-2xl">
							I&apos;m a well-organized person, problem solver, with high attention to detail.
						</p>
						<p className="py-5 text-justify min-[700px]:text-left text-[#f7f1e3]-600 text-base min-[700px]:text-xl min-[1100px]:text-2xl">
