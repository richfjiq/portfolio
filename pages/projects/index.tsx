...
const Projects = () => {
	return (
		<Navbar>
			<div className="flex flex-col max-w-[1240px] h-full px-4 justify-center">
				<h2 className="py-5 min-[900px]:pb-10 text-center">What I&apos;ve Built</h2>
